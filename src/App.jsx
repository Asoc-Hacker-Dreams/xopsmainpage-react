...
<div className="root home-main-section">
        ...
        <Navbar.Collapse id="responsive-navbar-nav" className="justify-content-between">
            ...
            <Link className='links px-4 font-weight-bold text-white' to="/#events" style={{ marginTop: '10px', marginBottom: '10px', textDecoration: 'none' }}>EVENTO</Link>
                ...
                <NavDropdown title="EVENTOS ANTERIORES" id="basic-nav-dropdown" className='links px-4 font-weight-bold text-white' style={{ marginTop: '10px', marginBottom: '10px', textDecoration: 'none', color: 'white' }}>
  {/* Submenú XOPS 2024 */}
