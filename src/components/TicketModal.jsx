...
import { BsCheckCircleFill, BsStar, BsCalendar3, BsGeoAlt } from 'react-icons/bs';
  ...
  return (
    <>
      ...
      >
        <Modal.Header
          closeButton
          style={{ background: '#1a1a2e', borderBottom: '2px solid #e94560' }}
        >
          <Modal.Title style={{ color: '#ffffff', fontWeight: 700, letterSpacing: '0.04em' }}>
            <span style={{ color: '#e94560', marginRight: '8px' }}>X-Ops Conference</span>
            {t('ticketModal.titleHighlight')}
          </Modal.Title>
        </Modal.Header>

        <Modal.Body style={{ background: '#0f0f1a', color: '#e0e0e0', minHeight: '300px' }}>
          <Container fluid>
              ...
              <div key={ev.id} className="event-section mb-5">
                <Row className="mb-3">
                  <Col>
                    ...
                    <div style={{ display: 'flex', gap: '16px', color: '#aaa', fontSize: '0.9rem', marginTop: '6px' }}>
                      {ev.startDate && (
                        <span>
                      ...
                      <Col md={6} lg={4} key={tt.id} className="mb-4">
                        <Card
                          ...
                          style={{
                            ...
                            border: style.highlighted ? '2px solid #e94560' : '1px solid #2a2a4a',
                            borderRadius: '12px',
                            color: '#e0e0e0',
                            position: 'relative',
                          }}
                        >
                          ...
                          <Card.Body style={{ paddingTop: style.badge ? '24px' : undefined }}>
                            <h3 style={{ color: '#ffffff', fontWeight: 700, fontSize: '1.1rem', letterSpacing: '0.06em', marginBottom: '8px' }}>
                              {tt.name.toUpperCase()}
                            </h3>
                            ...
                            {tt.description && (
                              <p style={{ color: '#999', fontSize: '0.85rem', marginBottom: '12px' }}>
                                {tt.description}
                              </p>
                            )}
                            <ul style={{ listStyle: 'none', padding: 0, marginBottom: '16px' }}>
                              <li style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '6px', fontSize: '0.85rem' }}>
                                <BsCheckCircleFill style={{ color: '#27ae60', flexShrink: 0 }} />
              ...
              <Row className="justify-content-center mt-2 mb-2">
                <Col lg={6} className="text-center">
                  <p style={{ color: '#aaa', fontSize: '0.9rem' }}>
                    ...
                    <a href={`mailto:${t('ticketModal.contactEmail')}`} style={{ color: '#e94560', textDecoration: 'none' }}>
        ...
        <Form onSubmit={handleSubmit} noValidate>
          <Modal.Body style={{ background: '#0f0f1a', color: '#e0e0e0' }}>
            ...
            <Form.Group className="mb-3">
              <Form.Label style={{ color: '#ccc' }}>{t('ticketModal.checkout.fullName')}</Form.Label>
              <Form.Control
                type="text"
            ...
            <Form.Group className="mb-3">
              <Form.Label style={{ color: '#ccc' }}>{t('ticketModal.checkout.email')}</Form.Label>
              <Form.Control
                type="email"
                ...
                style={{ background: '#1e1e3a', border: '1px solid #2a2a4a', color: '#fff' }}
              />
              <Form.Text style={{ color: '#888' }}>{t('ticketModal.checkout.emailHint')}</Form.Text>
            </Form.Group>
          </Modal.Body>
          <Modal.Footer style={{ background: '#1a1a2e', borderTop: '1px solid #2a2a4a' }}>
            ...
            <Button
              type="submit"
              disabled={purchasing}
              style={{ background: '#e94560', border: 'none', fontWeight: 600 }}
            >
